...
<div class="doc_box">
	...
	<p>The current architecture of TS is a centralized model (designed as a proof of concept) but is intended to be moved to a decentralized model. In this way the would be no central points to amass to much infomation/power. See also: <a href="https://en.wikipedia.org/wiki/Decentralized">https://en.wikipedia.org/wiki/Decentralized</a></p>
