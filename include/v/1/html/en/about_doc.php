...
<div class="doc_box">
	...
	<p>TS is an economic system of gifting goods and services based on a mix of personal and publicly-available-collective knowledge of individuals to those who are more deserving. It is a kind of donation based economy. TS will used the term [Identity-Based Merit System] to refer to this kind of system.</p>
	<p>Since TS is an [Identity-Based Merit System] rather than a [Monetary-Based Merit System], it is unique from other websites out there including ebay, craigslist, etc. because TS emphasizes "who you are" translating to what you deserve rather than "how much money you have" translating to what you deserve. However, there are still concerns about such a system.  One concern in an [Identity-Based Merit System] is that collective knowledge of an individual is shared to some extent to allow identity to be validated (resulting in some loss of privacy). Even so it is the hope of TS that people will be willing to give up a little privacy and share more about themselves to help create a self-regulating donation oriented economy.</p>
