...
switch($process['form_info']['type']) {
	...
	case 'donate':
		...
		include('list/v1/process/donate_process.php');
		exit;
	break;
	case 'sponsor':
		# separate for now until can merge
...
#  main update/insert
$sql = '';
include('list/v1/inline/edit_sql.php'); # not sure the best place but file is too big 2012-02-26 vaskoiii
if (!empty($sql));
	$result = mysql_query($sql) or die(mysql_error());
