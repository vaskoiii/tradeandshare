...
$x['site']['i'] = 'list/v1/'; # INCLUDE VERSION - v is default application dir. 1 is the version number.
$x['site']['p'] = 'list/v1/'; # PUBLIC VERSION  - Separated out so we can possibly share public media between versions instead of duplicating the whole directory.
